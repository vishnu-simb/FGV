...
/**
 * This is the model base class for the table "{{electronic_monitor}}".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "ElectronicMonitor".
 *
 * Columns in table "{{electronic_monitor}}" available as properties of the model,
 * followed by relations of table "{{electronic_monitor}}" available as properties of the model.
 *
 * @property string $id
 ...
 * @property Trap $trap
 */
abstract class BaseElectronicMonitor extends SimbActiveRecord{
