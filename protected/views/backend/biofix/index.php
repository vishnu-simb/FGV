...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'columns' => array(
		...
		array('name'=>'block','value'=>'$data->block->name','filter'=>CHtml::activeDropDownList($modelBiofix, 'block_id', CHtml::listData( $modelBiofix->getBlock()->getData() ,'id','name'),array('empty'=>'Select A Block'))),
		'second_cohort',
		'date',
