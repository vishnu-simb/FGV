...
'columns' => array(
		...
		array('name'=>'property','value'=>'$data->property->name','header'=>'Property','filter'=>CHtml::activeDropDownList($modelBlock,'property_id', CHtml::listData( $modelBlock->getPropertyByGrower() ,'id','name'),array('empty'=>'Select A Property'))),
