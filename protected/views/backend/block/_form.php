    ...
    <div class="span12">
        <div class="box box-bordered">
            ...
            <div class="box-content nopadding">
                            ...
                            <div class="span6"><?php echo $form->textFieldControlGroup($modelBlock, 'property_id', array('class' => 'input-xlarge', 'placeholder' => $modelBlock->getAttributeLabel('property_id'))); ?>
                            ...
                            <div class="span6"><?php echo $form->textFieldControlGroup($modelBlock, 'ordering', array('class' => 'input-xlarge', 'placeholder' => $modelBlock->getAttributeLabel('ordering'))); ?>
