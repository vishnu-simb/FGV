    ...
    <div class="span12">
        <div class="box box-bordered">
            ...
            <div class="box-content nopadding">
                <div class="span6">
					<?php echo $form->dropDownListControlGroup($modelBlock, 'property_id', CHtml::listData( $modelBlock->getProperty() ,'id','name'),array('empty' => 'Select A Property', 'class' => 'input-xlarge select2-minw'))?>
					...
					<?php echo $form->dropDownListControlGroup($modelBlock, 'tree_variety', CHtml::listData($modelBlock->getVariety() ,'id','name','fruit_type.name'), array('empty' => 'Select variety or enter new variety', 'class' => 'input-xlarge select2-minw')); ?>
                    <div class="control-group" id="new_variety_group">
                        <label class="control-label">-- New Variety</label>
                        <div class="controls">
                            <?php echo $form->dropDownList($modelBlock, 'fruit_type', CHtml::listData( $modelBlock->getFruitType() ,'id','name'),array('class' => 'input-xlarge select2-minw')); ?>
                            <input type="text" id="Block_new_variety" name="Block[new_variety]" placeholder="New Variety" class="input-xlarge" style="margin-top: 5px;"/>
                        </div>
                    </div>
