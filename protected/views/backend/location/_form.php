    ...
    <div class="span12">
        <div class="box box-bordered">
            ...
            <div class="box-content nopadding">
                            ...
                            <div class="span6"><?php echo $form->textFieldControlGroup($modelLocation, 'id', array('maxlength' => 100, 'class' => 'input-xlarge', 'placeholder' => $modelLocation->getAttributeLabel('id'))); ?>
                            ...
                            <div class="span6"><?php echo $form->textFieldControlGroup($modelLocation, 'created_at', array('class' => 'input-xlarge', 'placeholder' => $modelLocation->getAttributeLabel('created_at'))); ?>
