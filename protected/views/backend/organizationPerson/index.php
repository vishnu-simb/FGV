...
$this->breadcrumbs=array(
	'Organization People' => array('index'),
	Yii::t('app', 'Manage'),
);
...
$('.search-form-ext form').submit(function(){
	$('#organization-person-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	'id' => 'organization-person-grid',
	'dataProvider' => $modelOrganizationPerson->search(),
	'filter' => $modelOrganizationPerson,
