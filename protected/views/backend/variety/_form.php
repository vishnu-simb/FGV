    ...
    <div class="span12">
        <div class="box box-bordered">
            ...
            <div class="box-content nopadding">
                            ...
                            <div class="span6"><?php echo $form->textFieldControlGroup($modelVariety, 'name', array('maxlength' => 255, 'class' => 'input-xlarge', 'placeholder' => $modelVariety->getAttributeLabel('name'))); ?>
                            ...
                            <div class="span6"><?php echo $form->textFieldControlGroup($modelVariety, 'updated_at', array('class' => 'input-xlarge', 'placeholder' => $modelVariety->getAttributeLabel('updated_at'))); ?>
