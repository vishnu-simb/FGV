    ...
    <div class="span12">
        <div class="box box-bordered">
            ...
            <div class="box-content nopadding">
                            ...
                            <div class="span6"><?php echo $form->textFieldControlGroup($modelTrapCheck, 'trap_id', array('class' => 'input-xlarge', 'placeholder' => $modelTrapCheck->getAttributeLabel('trap_id'))); ?>
                            ...
                            <div class="span6"><?php echo $form->textFieldControlGroup($modelTrapCheck, 'ordering', array('class' => 'input-xlarge', 'placeholder' => $modelTrapCheck->getAttributeLabel('ordering'))); ?>
