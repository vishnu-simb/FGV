...
<div class="search-form-ext" style="display:none">
    <div class="box-content nopadding">
                    ...
                    <div class="span4">            <?php echo $form->textFieldControlGroup($modelTrapCheck, 'id', array('maxlength' => 10, 'class' => 'input-xlarge', 'placeholder' => $modelTrapCheck->getAttributeLabel('id'))); ?>
                                            ...
                                            <?php echo $form->textFieldControlGroup($modelTrapCheck, 'trap_id', array('class' => 'input-xlarge', 'placeholder' => $modelTrapCheck->getAttributeLabel('trap_id'))); ?>
                    ...
                    <div class="span4">            <?php echo $form->textAreaControlGroup($modelTrapCheck, 'comment', array( 'rows' => 6, 'class' => 'input-block-level', 'placeholder' => $modelTrapCheck->getAttributeLabel('comment'))); ?>
