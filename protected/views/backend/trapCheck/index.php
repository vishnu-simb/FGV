...
'columns' => array(
		...
		array('name'=>'grower','value'=>'$data->grower->name','header'=>'Grower','filter'=>CHtml::activeDropDownList($modelTrapCheck,'grower', CHtml::listData( $modelTrapCheck->getGrower() ,'id','name'),array('empty'=>'Select A Grower'))),
		array('name'=>'property','value'=>'$data->property->name','header'=>'Property','filter'=>CHtml::activeDropDownList($modelTrapCheck,'property', CHtml::listData( $modelTrapCheck->getPropertyByGrower() ,'id','name'),array('empty'=>'Select A Property'))),
		array('name'=>'block','value'=>'$data->block->name','header'=>'Block','filter'=>CHtml::activeDropDownList($modelTrapCheck,'block', CHtml::listData( $modelTrapCheck->getBlockByProperty() ,'id','name'),array('empty'=>'Select A Block'))),
		array('name'=>'trap','value'=>'$data->trap->name','header'=>'Trap','filter'=>CHtml::activeDropDownList($modelTrapCheck, 'trap', CHtml::listData($modelTrapCheck->getTrapByBlock() ,'name','name'),array('empty'=>'Select A Trap'))),
		'date',
		'value',
		'comment',
		/*
