    ...
    <div class="span12">
        <div class="box box-bordered">
            ...
            <div class="box-content nopadding">
                            ...
                            <div class="span6">
                            <?php //echo $form->textFieldControlGroup($modelMiteMonitor, 'creator_id', array('maxlength' => 20, 'class' => 'input-xlarge', 'placeholder' => $modelMiteMonitor->getAttributeLabel('creator_id'))); ?>

                            <?php //echo $form->textFieldControlGroup($modelMiteMonitor, 'ordering', array('class' => 'input-xlarge', 'placeholder' => $modelMiteMonitor->getAttributeLabel('ordering'))); ?>

                            <?php //echo $form->textFieldControlGroup($modelMiteMonitor, 'created_at', array('class' => 'input-xlarge', 'placeholder' => $modelMiteMonitor->getAttributeLabel('created_at'))); ?>

                            <?php //echo $form->textFieldControlGroup($modelMiteMonitor, 'updated_at', array('class' => 'input-xlarge', 'placeholder' => $modelMiteMonitor->getAttributeLabel('updated_at'))); ?>

                            <?php //echo $form->textFieldControlGroup($modelMiteMonitor, 'status', array('class' => 'input-xlarge', 'placeholder' => $modelMiteMonitor->getAttributeLabel('status'))); ?>

                            <?php //echo $form->textFieldControlGroup($modelMiteMonitor, 'is_deleted', array('class' => 'input-xlarge', 'placeholder' => $modelMiteMonitor->getAttributeLabel('is_deleted'))); ?>

                            <?php //echo $form->textAreaControlGroup($modelMiteMonitor, 'params', array( 'rows' => 6, 'class' => 'input-block-level', 'placeholder' => $modelMiteMonitor->getAttributeLabel('params'))); ?>
</div>
