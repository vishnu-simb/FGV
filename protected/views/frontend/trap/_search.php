...
<div class="search-form-ext" style="display:none">
    <div class="box-content nopadding">
                ...
                <div class="span4">     
                    <?php //echo $form->textFieldControlGroup($modelTrap, 'id', array('class' => 'input-xlarge', 'placeholder' => $modelTrap->getAttributeLabel('id'))); ?>
                    ...
                    <?php echo $form->dropDownListControlGroup($modelTrap, 'pest_id', CHtml::listData( $modelTrap->getPest() ,'id','name'),array('empty'=>'Select A Pest'))?>
   				    ...
   				    <?php echo $form->dropDownListControlGroup($modelTrap, 'block_id', CHtml::listData( $modelTrap->getBlockByProperty() ,'id','name'),array('empty'=>'Select A Block'))?>
                ...
                <div class="span4">    
                    <?php echo $form->dropDownListControlGroup($modelTrap, 'property', CHtml::listData( $modelTrap->getPropertyByGrower() ,'id','name'),array('empty'=>'Select A Block'))?>
                </div>
            </div>
