...
'columns' => array(
		...
		array('name'=>'name','filter'=>CHtml::activeDropDownList($modelProperty,'name', CHtml::listData( $modelProperty->getPropertyByGrower() ,'name','name'),array('empty'=>'Select A Property'))),
		/*
		'creator_id',
		'ordering',
