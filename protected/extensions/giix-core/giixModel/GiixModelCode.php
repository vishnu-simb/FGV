...
class GiixModelCode extends ModelCode {
	...
	public function prepare() {
		...
		foreach ($tables as $table) {
            ...
            $this->files[] = new CCodeFile(
                Yii::getPathOfAlias($this->modelPath . '._common.Common' . $this->modelClass) . '.php',
                $this->render($templatePath . DIRECTORY_SEPARATOR . '_common' . DIRECTORY_SEPARATOR . 'commonmodel.php', $params)
            );
		}
	}
